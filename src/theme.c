...
const Theme THEME_DARK = {
    ...
    .hope      = RGB(0xFF, 0xD2, 0x4A),
    .fear      = RGB(0xB0, 0x7C, 0xFF),
    .turn      = RGB(0xFF, 0xE9, 0x8A),
    ...
    .fog_tint = {
        RGB(0x4C, 0x22, 0x22), RGB(0x22, 0x2E, 0x4C), RGB(0x3A, 0x4C, 0x22),
        RGB(0x4C, 0x22, 0x47), RGB(0x22, 0x4C, 0x45), RGB(0x4C, 0x39, 0x22),
        RGB(0x2C, 0x22, 0x4C), RGB(0x24, 0x4C, 0x22), RGB(0x4C, 0x22, 0x30),
        RGB(0x22, 0x3C, 0x4C), RGB(0x49, 0x4C, 0x22), RGB(0x43, 0x22, 0x4C),
        RGB(0x22, 0x4C, 0x37), RGB(0x4C, 0x2B, 0x22), RGB(0x22, 0x26, 0x4C),
    },
    /* Below the floor's own 0E0E12 and bluer, so what the players cannot
     * see reads as a shadow over the map rather than as a terrain. */
    .fog_gm_bg = RGB(0x06, 0x07, 0x10),
    .terrain_bg = {
